...
import type { EncryptionContext } from './interfaces/encryptionContext';
import type { KdfInterface } from './interfaces/kdfInterface';

import { INPUT_LENGTH_LIMIT } from './consts';
import { ExportError, InvalidParamError } from './errors';
import { emitNotSupported } from './utils/emitNotSupported';
...
export class SenderExporterContextImpl
  extends ExporterContextImpl
