...
import { EMPTY, INPUT_LENGTH_LIMIT, MINIMUM_PSK_LENGTH } from './consts';
import { InvalidParamError } from './errors';
import {
  RecipientExporterContextImpl,
  SenderExporterContextImpl,
} from './exporterContext';
import { AeadId, Mode } from './identifiers';
import { RecipientContextImpl } from './recipientContext';
import { SenderContextImpl } from './senderContext';
...
// b"HPKE"
// deno-fmt-ignore
const SUITE_ID_HEADER_HPKE = new Uint8Array([72, 80, 75, 69, 0, 0, 0, 0, 0, 0]);
 ...
 *   HkdfSha256,
 *   CipherSuite,
 * } from "http://deno.land/x/hpke/mod";
 *
 ...
 *
 * ```ts
 * import { Aes128Gcm, HkdfSha256, CipherSuite } from "http://deno.land/x/hpke/mod";
 * // Use an extension module.
 * import { DhkemX25519HkdfSha256 } from "https://deno.land/x/hpke/x/dhkem-x25519/mod";
 *
 * const suite = new CipherSuite({
...
export class CipherSuiteNative extends NativeAlgorithm {
  ...
  private async _keySchedule(
    ...
    const pskId =
      params.psk === undefined ? EMPTY : new Uint8Array(params.psk.id);
    ...
    const info =
      params.info === undefined ? EMPTY : new Uint8Array(params.info);
    ...
    const psk =
      params.psk === undefined ? EMPTY : new Uint8Array(params.psk.key);
