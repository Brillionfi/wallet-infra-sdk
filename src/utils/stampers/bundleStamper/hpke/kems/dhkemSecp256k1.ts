...
import { Secp256k1 } from './dhkemPrimitives/secp256k1';
 ...
 *
 * ```ts
 * import { AeadId, CipherSuite, KdfId } from "https://deno.land/x/hpke/mod";
 * import { DhkemSecp256k1HkdfSha256 } from "https://deno.land/x/hpke/x/dhkem-secp256k1/mod";
 *
 ...
 *   CipherSuite,
 *   HkdfSha256,
 * } from "https://deno.land/x/hpke/core/mod";
 * import { DhkemSecp256k1HkdfSha256 } from "https://deno.land/x/hpke/x/dhkem-secp256k1/mod";
 *
 * const suite = new CipherSuite({
 *   kem: new DhkemSecp256k1HkdfSha256(),
