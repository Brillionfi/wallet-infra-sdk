import type { DhkemPrimitives } from '../../interfaces/dhkemPrimitives';
...
import { KEM_USAGES, LABEL_DKP_PRK } from '../../interfaces/dhkemPrimitives';
import { Bignum } from '../../utils/bignum';
import { base64UrlToBytes, i2Osp } from '../../utils/misc';
...
const PKCS8_ALG_ID_P_256 = new Uint8Array([
  48, 65, 2, 1, 0, 48, 19, 6, 7, 42, 134, 72, 206, 61, 2, 1, 6, 8, 42, 134, 72,
  206, 61, 3, 1, 7, 4, 39, 48, 37, 2, 1, 1, 4, 32,
]);

// deno-fmt-ignore
const PKCS8_ALG_ID_P_384 = new Uint8Array([
  48, 78, 2, 1, 0, 48, 16, 6, 7, 42, 134, 72, 206, 61, 2, 1, 6, 5, 43, 129, 4,
  0, 34, 4, 55, 48, 53, 2, 1, 1, 4, 48,
]);

// deno-fmt-ignore
const PKCS8_ALG_ID_P_521 = new Uint8Array([
  48, 96, 2, 1, 0, 48, 16, 6, 7, 42, 134, 72, 206, 61, 2, 1, 6, 5, 43, 129, 4,
  0, 35, 4, 73, 48, 71, 2, 1, 1, 4, 66,
]);
