...
import { LABEL_DKP_PRK, LABEL_SK } from '../interfaces/dhkemPrimitives';
import { SUITE_ID_HEADER_KEM } from '../interfaces/kemInterface';
import { concat, i2Osp, isCryptoKeyPair } from '../utils/misc';
...
export class Hybridkem implements KemInterface {
  ...
  public async deriveKeyPair(ikm: ArrayBuffer): Promise<CryptoKeyPair> {
    ...
    const seed = new Uint8Array(
      await this._kdf.labeledExpand(dkpPrk, LABEL_SK, EMPTY, 32 + 64),
    );
